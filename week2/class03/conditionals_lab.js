...
function whatCanYouDo (age) {
	...
	if (age < 16) {
		...
		console.log('you can drive! YES!');
	} else if (age >= 18 && age < 21) {
		console.log('you can vote! YES!');
	} else if (age >= 21 && age < 25) {
		console.log('you can drink! YES!');
	} else if (age >= 25 && age < 35) {
		console.log('you can rent a car! YES!');
	} else if (age >= 35 && age < 62) {
		console.log('you can run for pres! YES!');
	} else if (age >= 62) {
		console.log('you can collect social security benefits! YES!');
	}
}
